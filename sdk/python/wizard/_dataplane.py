"""Data-plane client: sandbox operations straight to the agent through wizard-proxy.
...
AGENT_PORT = 10001
_SERVICE = "wizard.agent.v1.AgentService"
...
class DataPlane:
    """Reaches a sandbox's agent through wizard-proxy over Connect HTTP/JSON.
