...
const (
	NodeService_Register_FullMethodName         = "/wizard.node.v1.NodeService/Register"
	NodeService_Heartbeat_FullMethodName        = "/wizard.node.v1.NodeService/Heartbeat"
	NodeService_SyncState_FullMethodName        = "/wizard.node.v1.NodeService/SyncState"
	NodeService_UpdateNodeStatus_FullMethodName = "/wizard.node.v1.NodeService/UpdateNodeStatus"
)
...
//
// NodeService: wizardd -> control plane (outbound).
...
var NodeService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "wizard.node.v1.NodeService",
	...
	Metadata: "wizard/node/v1/node.proto",
}

const (
	SandboxService_CreateSandbox_FullMethodName      = "/wizard.node.v1.SandboxService/CreateSandbox"
	SandboxService_DestroySandbox_FullMethodName     = "/wizard.node.v1.SandboxService/DestroySandbox"
	SandboxService_PauseSandbox_FullMethodName       = "/wizard.node.v1.SandboxService/PauseSandbox"
	SandboxService_ResumeSandbox_FullMethodName      = "/wizard.node.v1.SandboxService/ResumeSandbox"
	SandboxService_GetSandbox_FullMethodName         = "/wizard.node.v1.SandboxService/GetSandbox"
	SandboxService_SnapshotSandbox_FullMethodName    = "/wizard.node.v1.SandboxService/SnapshotSandbox"
	SandboxService_RestoreSandbox_FullMethodName     = "/wizard.node.v1.SandboxService/RestoreSandbox"
	SandboxService_StartUserProcess_FullMethodName   = "/wizard.node.v1.SandboxService/StartUserProcess"
	SandboxService_PrewarmImage_FullMethodName       = "/wizard.node.v1.SandboxService/PrewarmImage"
	SandboxService_StartBuild_FullMethodName         = "/wizard.node.v1.SandboxService/StartBuild"
	SandboxService_GetBuildStatus_FullMethodName     = "/wizard.node.v1.SandboxService/GetBuildStatus"
	SandboxService_CancelBuild_FullMethodName        = "/wizard.node.v1.SandboxService/CancelBuild"
	SandboxService_ConfigureAdmission_FullMethodName = "/wizard.node.v1.SandboxService/ConfigureAdmission"
	SandboxService_Exec_FullMethodName               = "/wizard.node.v1.SandboxService/Exec"
	SandboxService_StreamExec_FullMethodName         = "/wizard.node.v1.SandboxService/StreamExec"
	SandboxService_ReadFile_FullMethodName           = "/wizard.node.v1.SandboxService/ReadFile"
	SandboxService_WriteFile_FullMethodName          = "/wizard.node.v1.SandboxService/WriteFile"
	SandboxService_DeleteFile_FullMethodName         = "/wizard.node.v1.SandboxService/DeleteFile"
	SandboxService_ListDir_FullMethodName            = "/wizard.node.v1.SandboxService/ListDir"
	SandboxService_GetLogs_FullMethodName            = "/wizard.node.v1.SandboxService/GetLogs"
)
...
// For semantics around ctx use and closing/ending streaming RPCs, please refer to https://pkg.go.dev/google.golang.org/grpc/?tab=doc#ClientConn.NewStream.
//
// SandboxService: implemented by wizardd; control plane / gateway call it
...
var SandboxService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "wizard.node.v1.SandboxService",
